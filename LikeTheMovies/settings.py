"""
Django settings for LikeTheMovies project.
...
SECRET_KEY = 'lt_0(gv2ubaf_bwa5(#8qsfpzmq#!5r@h@++2cxkm98ns6nrx0'
...
ROOT_URLCONF = 'LikeTheMovies.urls'

WSGI_APPLICATION = 'LikeTheMovies.wsgi.application'
